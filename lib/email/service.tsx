...
export async function sendSenderNotificationEmail(data: {
  ...
  const subject = `Shipment Update - ${data.status.toUpperCase()} - #${data.tracking_number}`;
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="padding: 20px;">
        ...
        <p>Track the shipment: 
          <a href="${baseUrl}/track?tracking=${data.tracking_number}">View Details</a>
        </p>
      </div>
    </div>
  `;
