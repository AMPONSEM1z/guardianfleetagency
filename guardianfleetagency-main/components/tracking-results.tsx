    ...
    <div className="space-y-6">
      ...
      <Card className="p-6">
        <CardHeader className="p-0 mb-6">
          <div className="flex items-center justify-between">
            <CardTitle className="text-2xl text-navy">Shipment Details</CardTitle>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 font-mono">{shipment.tracking_number}</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">{formatServiceType(shipment.service_type)}</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-navy">
                  {shipment.actual_delivery_date ? "Delivered On" : "Estimated Delivery"}
                </h3>
            ...
            {(shipment.weight_kg || shipment.dimensions_cm) && (
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  {shipment.weight_kg && <p className="text-gray-600">{shipment.weight_kg} kg</p>}
                  {shipment.dimensions_cm && <p className="text-gray-600">{shipment.dimensions_cm} cm</p>}
                  {shipment.package_description && (
                    <p className="text-sm text-gray-500">{shipment.package_description}</p>
                  )}
                </div>
              </div>
            )}
      ...
      <Card className="p-6">
        <CardHeader className="p-0 mb-6">
          ...
          <p className="text-gray-600">Real-time updates on your package's journey</p>
        </CardHeader>
        <CardContent className="p-0">
          {tracking_events.length > 0 ? (
            <div className="space-y-4">
              {tracking_events.map((event, index) => (
                ...
                >
                  <div className={`w-3 h-3 rounded-full mt-2 ${index === 0 ? "bg-army-green" : "bg-gray-300"}`}></div>
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      <div>
                        <p className="font-medium text-navy">{event.event_description}</p>
