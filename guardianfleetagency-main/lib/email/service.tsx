...
// const emailConfig: EmailConfig = {
//   from: "Guardian Fleet Agency <GuardianFleetAgency@gmail.com>",
//   replyTo: "GuardianFleetAgency@gmail.com",
// };
  ...
  try {
    ...
    const footer = `
      ...
      <p style="font-size:12px;color:#777;text-align:center;">
        Sent by Guardian Fleet Agency • guardianfleetagency@gmail.com<br/>
        You can reply directly to this email for support.
      </p>
    `;
    ...
    const mailOptions = {
      ...
      subject,
      html: `${html}${footer}`,
      text: `${text}\n\n---\nSent by Guardian Fleet Agency • guardianfleetagency@gmail.com`,
      headers: {
        "X-Priority": "3",
        "X-Mailer": "GuardianFleetAgency-Mailer",
        "List-Unsubscribe": "<mailto:guardianfleetagency@gmail.com>",
      },
    };
...
export async function sendSenderNotificationEmail(data: {
  ...
  const text = `
Guardian Fleet Agency - Shipment Update
...
${data.message}
  ...
  return await sendEmail(
    "GuardianFleetAgency@gmail.com", // ✅ direct to your Gmail inbox
    subject,
    html,
    text
  );
