    ...
    <div className="min-h-screen flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-balance">
                Military-Grade <span className="text-gold">Shipping</span> &
                Logistics
              </h1>
              <p className="text-xl mb-8 text-gray-200 text-pretty">
                Precision. Reliability. Excellence. Your packages delivered with
                the discipline and commitment of military operations.
              </p>
          ...
          <Card className="p-6">
            <CardContent className="p-0">
              ...
              >
                ...
                <Button
                  type="submit"
                  className="bg-army-green hover:bg-army-green-light text-white font-semibold"
                >
                  Track Package
                </Button>
              </form>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-navy mb-4">
              Why Choose guardianfleetagency?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto text-pretty">
              We bring military precision to civilian shipping, ensuring your
              packages are handled with the utmost care and delivered on time,
              every time.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600">
                  Military-grade security protocols protect your packages
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600">
                  Precision timing ensures your packages arrive exactly when
                  promised.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600">
                  Advanced tracking technology keeps you informed every step of
                  the way.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600">
                  Worldwide shipping network with local expertise in every
                  region.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto text-pretty">
              From standard shipping to express overnight delivery, we have the
              right solution for your logistics needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-6 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 mb-4">
                  Reliable delivery within 3-5 business days with full tracking
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow border-gold border-2">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 mb-4">
                  Priority handling with guaranteed delivery within 1-2 business
                  days.
                </p>
                <ul className="text-sm text-gray-500 space-y-1">
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-gray-600 mb-4">
                  Critical delivery service with next business day guarantee by
                  10:30 AM.
                </p>
                <ul className="text-sm text-gray-500 space-y-1">
      ...
      <section className="py-20 bg-army-green text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-gray-200 text-pretty">
            Join thousands of satisfied customers who trust guardianfleetagency
            for their most important deliveries.
          </p>
