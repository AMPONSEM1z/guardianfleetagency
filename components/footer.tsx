      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-gold">GuardFleetAgency</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Military-grade shipping and logistics services with precision, reliability, and unwavering commitment to
              excellence. Your packages are our mission.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/track" className="text-gray-300 hover:text-gold transition-colors">
                  Track Package
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-navy-light mt-8 pt-8 text-center">
          <p className="text-gray-300">
            © 2000 GuardianFleetAgency. All rights reserved. |
            <Link href="/privacy" className="hover:text-gold transition-colors ml-1">
              Privacy Policy
            </Link>{" "}
            |
            <Link href="/terms" className="hover:text-gold transition-colors ml-1">
              Terms of Service
            </Link>
          </p>
        </div>
